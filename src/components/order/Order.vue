  ...
  <div>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="addressViseible = false">取 消</el-button>
        <el-button type="primary" @click="addressViseible = false">确 定</el-button>
      </span>
    </el-dialog>
    <!-- 展示物流进度的对话框 -->
